...
win32['GLFW_CMAKE_OPTS'] = '-D CMAKE_TOOLCHAIN_FILE=$BASEDIR/ext_libs/win32.cmake'
...
win64['GLFW_CMAKE_OPTS'] = '-D CMAKE_TOOLCHAIN_FILE=$BASEDIR/ext_libs/win64.cmake'
...
native.Append(LIBS=['X11','Xxf86vm','Xrandr','pthread','Xi'])
native['OPENGL'] = 'GL'
